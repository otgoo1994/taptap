	...
	export default ({
		...
		data() {
			return {
				...
				lessonGroup: [],
				options: {
					types: [{value: 'video', label: 'Бичлэг'}, {value: 'intro', label: 'Шинэ үсэг'}, {value: 'boxed', label: 'Давтлага үсэг'}, {value: 'review', label: 'Давтлага өгүүлбэр'}, {value: 'hold', label: '1 гарын дадлага'}, {value: 'pool', label: 'Тоглоом (Усан сан)'}, {value: 'floppy', label: 'Тоглоом (Floppy bird)'}, {value: 'ninja', label: 'Тоглоом (Word ninja)'}],
